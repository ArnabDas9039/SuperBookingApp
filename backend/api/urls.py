...
urlpatterns = [
    ...
    path(
        "booking/<str:booking_reference>", views.BookingView.as_view(), name="booking"
    ),
    path("booking/create/", views.CreateBookingView.as_view(), name="createbooking"),
    path(
        "payments/create/", views.CreatePaymentView.as_view(), name="createpayment"
    ),  # return json file
    path(
        "payments/create/page/",
        views.CreatePaymentPageView.as_view(),
        name="paymentpage",
    ),  # returns html page
